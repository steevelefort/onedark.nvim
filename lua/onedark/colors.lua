local colors = {
    ...
    bg0         = { '#282c34', '#1f2329' , '#242b38' , '#1F1F27' , '#2c2d30' , '#232326', '#fafafa' },
    bg1         = { '#31353f', '#282c34' , '#2d3343' , '#28282F' , '#35373b' , '#2c2d31', '#f0f0f0' },
    bg2         = { '#393f4a', '#30363f' , '#343e4f' , '#283347' , '#3e4045' , '#35363b', '#e6e6e6' },
    bg3         = { '#3b3f4c', '#323641' , '#363c51' , '#44444F' , '#404247' , '#37383d', '#dcdcdc' },
    bg_d        = { '#21252b', '#181b20' , '#1e242e' , '#17171f' , '#242628' , '#1b1c1e', '#c9c9c9' },
    bg_blue     = { '#73b8f1', '#61afef' , '#6db9f7' , '#009BFF' , '#79b7eb' , '#68aee8', '#68aee8' },
    bg_yellow   = { '#ebd09c', '#e8c88c' , '#f0d197' , '#f2cc81' , '#e6cfa1' , '#e2c792', '#e2c792' },
    fg          = { '#abb2bf', '#a0a8b7' , '#a5b0c5' , '#FFFFFF' , '#b1b4b9' , '#a7aab0', '#383a42' },
    purple      = { '#c678dd', '#bf68d9' , '#ca72e4' , '#D86BFF' , '#c27fd7' , '#bb70d2', '#a626a4' },
    green       = { '#98c379', '#8ebd6b' , '#97ca72' , '#00FF79' , '#99bc80' , '#8fb573', '#50a14f' },
    orange      = { '#d19a66', '#cc9057' , '#d99a5e' , '#FFAA00' , '#c99a6e' , '#c49060', '#c18401' },
    blue        = { '#61afef', '#4fa6ed' , '#5ab0f6' , '#00BEFF' , '#68aee8' , '#57a5e5', '#4078f2' },
    yellow      = { '#e5c07b', '#e2b86b' , '#ebc275' , '#B0B0B0' , '#dfbe81' , '#dbb671', '#986801' },
    cyan        = { '#56b6c2', '#48b0bd' , '#4dbdcb' , '#34bfd0' , '#5fafb9' , '#51a8b3', '#0184bc' },
    red         = { '#e86671', '#e55561' , '#ef5f6b' , '#FF155F' , '#e16d77' , '#de5d68', '#e45649' },
    grey        = { '#5c6370', '#535965' , '#546178' , '#555555' , '#646568' , '#5a5b5e', '#a0a1a7' },
