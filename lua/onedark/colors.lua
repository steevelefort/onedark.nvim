local colors = {
    ...
    bg3         = { '#3b3f4c', '#323641' , '#363c51' , '#3a428a' , '#404247' , '#37383d', '#dcdcdc' },
    bg_d        = { '#21252b', '#181b20' , '#1e242e' , '#141b24' , '#242628' , '#1b1c1e', '#c9c9c9' },
    bg_blue     = { '#73b8f1', '#61afef' , '#6db9f7' , '#008BFF' , '#79b7eb' , '#68aee8', '#68aee8' },
    bg_yellow   = { '#ebd09c', '#e8c88c' , '#f0d197' , '#f2cc81' , '#e6cfa1' , '#e2c792', '#e2c792' },
    fg          = { '#abb2bf', '#a0a8b7' , '#a5b0c5' , '#FFFFFF' , '#b1b4b9' , '#a7aab0', '#383a42' },
    purple      = { '#c678dd', '#bf68d9' , '#ca72e4' , '#C85BFF' , '#c27fd7' , '#bb70d2', '#a626a4' },
    green       = { '#98c379', '#8ebd6b' , '#97ca72' , '#00FF79' , '#99bc80' , '#8fb573', '#50a14f' },
    orange      = { '#d19a66', '#cc9057' , '#d99a5e' , '#FF9A00' , '#c99a6e' , '#c49060', '#c18401' },
    blue        = { '#61afef', '#4fa6ed' , '#5ab0f6' , '#009EFF' , '#68aee8' , '#57a5e5', '#4078f2' },
    yellow      = { '#e5c07b', '#e2b86b' , '#ebc275' , '#FFFD00' , '#dfbe81' , '#dbb671', '#986801' },
    cyan        = { '#56b6c2', '#48b0bd' , '#4dbdcb' , '#34bfd0' , '#5fafb9' , '#51a8b3', '#0184bc' },
    red         = { '#e86671', '#e55561' , '#ef5f6b' , '#FF1A4F' , '#e16d77' , '#de5d68', '#e45649' },
